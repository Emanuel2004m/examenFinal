        ...
        <table id="myTabla" class="table table-striped mb-0">
            ...
            <?php foreach ((array) $rows as $row) { ?>
                <tr>
                    ...
                    <td><?=$row['alias']?></td>
                    <td>
                        <a href="edit.php?id=<?=$row['idUsuario']?>" class="btn btn-warning">Editar</a>
                        <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#iddel<?=$row['idUsuario']?>">Eliminar</a>
