...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
		...
		<tr>
           <td style="width:50%;" >
			<?php
				$cadenaRazonSocial = "";
				$cadenaRazonSocial .= "
					<pre><b>CLIENTE: </b>" .$cliente['nomCliente'].
						"<br><b>CI / RUC: </b>".$cliente['cni'].                      
					"</pre>";
    ...
    foreach ($arrDetalles as $fila) {
        $idConsulta = $fila["idConcepto"];
        $concepto = $fila['concepto'];
        $importe=$precio_unitario = $fila['unitario'];

        $insertdetail = $object->insertdetail($numero,$idConsulta,$importe);
        ...
        $precio_total=$precio_unitario_r;
