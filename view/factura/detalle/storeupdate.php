<?php
	...
	//agrega un detalle
	if (!empty($idConcepto) and !empty($unitario)) {
			if ( $exist ) {
			...
			$arregloDetalles = array ('idTmpDetalle'=>$ultimoID,'idConcepto'=>$idConcepto,'concepto'=>$concepto,'unitario'=>$unitario,'sesion'=>$sesion);
