        ...
        <table id="myTabla" class="table table-striped mb-0">
            ...
            <?php foreach ((array) $rows as $row) { ?>
                <tr>
                    ...
                    <td>
                        <a href="edit.php?id=<?=$row['idEspecialidad']?>" class="btn btn-warning">Editar</a>
                        <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#iddel<?=$row['idEspecialidad']?>">Eliminar</a>
