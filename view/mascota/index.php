        ...
        <table id="myTabla" class="table table-striped mb-0">
            ...
            <?php foreach ((array) $rows as $row) { ?>
                <tr>
                    ...
                    <td>
                        <a href="edit.php?id=<?=$row['idMascota']?>" class="btn btn-warning">Editar</a>
                        <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#iddel<?=$row['idMascota']?>">Eliminar</a>
