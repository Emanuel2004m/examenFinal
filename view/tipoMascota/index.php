        ...
        <table id="myTabla" class="table table-striped mb-0">
            ...
            <?php foreach ((array) $rows as $row) { ?>
                <tr>
                    ...
                    <td>
                        <a href="edit.php?id=<?=$row['idTipo']?>" class="btn btn-warning">Editar</a>
                        <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#iddel<?=$row['idTipo']?>">Eliminar</a>
            ...
            <div class="container" id="ventana" style="display:none;">
                ...
                <table class="table table-striped mb-0" style="font-size: 2.00rem;">
                    ...
                    <?php foreach ($rows as $row) { ?>
                        <tr>
                            <td colspan="1"><?=$row['idEspecialidad']?></td>
